...
exports.AVAIL_EQUIP = [
	"NIK", "BDG1", "BDG2", "BDG3", "BDG4", "BDGE", "BDGS", "CPT1",
...
var TIME = [[10, 30, 60, 90, 120, 150], [20, 60, 120, 180, 240, 300], [20, 40, 60, 80, 120, 180]];
exports.RULE = {
/*
	유형: { lang: 언어,
		rule: 이름,
...
*/
	...
	'KKT': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "gen", "ext", "mis", "loa", "str", "k32", "olb", "nol"],
		time: TIME[0],
		ai: true,
		big: false,
		ewq: true
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "gen", "ext", "mis", "loa", "str", "olb", "nol"],
		time: TIME[0],
		ai: true,
		big: false,
		ewq: true
...
exports.KO_INJEONG = [
	...
	"HSS", /*"KMV",*/ "HDC", "HOS", "MOV", /*"KRS",*/

	"KWT", "KBS", "LIC", "JVN", "JTP", "STG", "ONE", "CRY", "NVL", "MCL", "SVN", "JPT"
];
exports.EN_INJEONG = [
	"LOL"
];
